...
1. Dependencies, you need python installed to run this command, but running the command will install the required
libraries for this workspace:
pip install -r requirements.txt

2. You'll need docker running. When you have docker running you can run the following command to setup your docker container,
...
3. Now we need to set our client_secret. find container name under docker ps and use it in every {CONTAINER_NAME} placement. I.e replace {CONTAINER_NAME} with the appropriate container name.
